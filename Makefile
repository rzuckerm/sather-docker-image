SATHER_VERSION := $(shell cat SATHER_VERSION)
SATHER_DEPS := $(wildcard SATHER_*)
DOCKER_TAG_PREFIX := rzuckerm/sather:$(SATHER_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(SATHER_DEPS)
